    ...
    <div className="relative flex flex-col h-full overflow-hidden canvas-glow">
      ...
      <ScrollCanvas onScroll={onScroll}>
        <div className="max-w-[720px] mx-auto px-4 sm:px-8 pt-8 pb-12 flex flex-col gap-6">
          <BackLink href="/admin/reports/flagged" label="Back to flagged responses" />
          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              <Button size="cta" variant="outline" onClick={() => router.push(flag.source ? `/admin/content/${flag.source.docId}` : "/admin/content")}>
                <Pencil size={16} strokeWidth={1.5} /> Review content
              </Button>
              {flag.status === "open" && (
                <Button size="cta" onClick={() => { resolveFlag(flag.id); showToast({ title: "Flag resolved" }); }}>
