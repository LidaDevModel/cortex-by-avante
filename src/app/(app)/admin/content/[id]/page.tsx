...
export default function AdminDocumentEditorPage() {
  ...
  if (!found) {
    return (
      <div className="relative flex flex-col h-full overflow-hidden canvas-glow">
        <PageHeader crumbs={[{ label: "Cortex Manage", href: "/admin" }, { label: "Library", href: "/admin/content" }, { label: "Not found" }]} className={headerClassName} />
  ...
  return (
    <div className="relative flex flex-col h-full overflow-hidden canvas-glow">
      <PageHeader crumbs={[{ label: "Cortex Manage", href: "/admin" }, { label: "Library", href: "/admin/content" }, { label: found.doc.name }]} className={headerClassName} />
