  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <input
        ...
        autoComplete="off"
        spellCheck={false}
        className="w-full h-12 pl-9 pr-8 rounded-[8px] border border-input bg-surface dark:bg-input/30 text-[14px] leading-[20px] text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 transition-shadow duration-100"
