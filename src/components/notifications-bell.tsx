...
export function NotificationsBell() {
  ...
  const bellButton = (
    <button
      ...
      className="relative flex items-center justify-center size-11 md:size-10 rounded-lg text-muted-foreground transition-colors duration-100 hover:text-foreground hover:bg-foreground/5 cursor-pointer"
    >
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <SheetClose asChild>
                  <button
                    type="button"
                    aria-label="Close"
                    className="-mr-1.5 flex items-center justify-center size-11 md:size-10 rounded-lg text-muted-foreground transition-colors duration-100 hover:text-foreground hover:bg-foreground/5 cursor-pointer"
                  >
